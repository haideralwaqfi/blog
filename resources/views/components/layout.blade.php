            ...
            <div class="mt-8 md:mt-0 flex items-center">
                @auth
                    <x-dropdown>
                        ...
                        @admin
                            <x-dropdown-item :active="request()->is('admin/posts/create')" href="/admin/posts/create">New Post</x-dropdown-item>
                            <x-dropdown-item :active="request()->is('/')" href="/">Dashboard</x-dropdown-item>
                        @endadmin
